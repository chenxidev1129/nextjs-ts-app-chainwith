...
export default function NftItem({
  ...
  return (
    <div key={key} className="flex flex-row items-center gap-6 bg-white border border-[#EBEFF1] shadow-[0px_4px_4px_rgba(0,0,0,0.1)] rounded-[15px]" onClick={() => router.push('/wallet/detail?id=' + id)}>
